...
start https://www.youtube.com/watch?v=j9yEL3B5Cvk&list=RDj9yEL3B5Cvk&start_radio=1&pp=ygUcc29tZXRoaW5nIGFib3V0IHlvdSBleWVkcmVzc6AHAQ%3D%3D
echo Regresando al menu principal...
goto inicio

:videoFav2
echo Ingresando a youtube para reproducir Video Favorito 2...
start https://www.youtube.com/watch?v=rscOXVuaCGw&list=RDrscOXVuaCGw&start_radio=1
echo Regresando al menu principal...
goto inicio
